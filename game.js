...
function gameOver() {
  ...
  const liberalMessages = [
    'Your safe space has been compromised!',
    'Healthcare denied. Please try again.',
    'You got ratioed on X (formerly Twitter).',
    'You exceeded your NPR listening limit.',
    'You were flagged for microaggressions. Yikes.',
    'You ran out of fair-trade coffee.',
    'You forgot your land acknowledgement!'
  ];
  const randomMsg = liberalMessages[Math.floor(Math.random() * liberalMessages.length)];
  messageElem.innerHTML = `
    <div style='font-size:2em;font-weight:bold;'>LIBERAL</div>
    <div style='font-size:1em;margin-top:1em;'>Press Space, Enter, or Tap to Restart</div>
    <div style='font-size:0.9em;margin-top:0.7em;color:#fff;text-shadow:1px 1px 2px #222;'>${randomMsg}</div>
  `;
